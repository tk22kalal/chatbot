...
async def try_match_users(client: Bot, user_id: int, user: dict):
    ...
    if available_users:
        ...
        # Send to both users
        await client.send_message(user_id, PARTNER_FOUND_MSG, reply_markup=chat_keyboard)
        await client.send_message(partner_id, PARTNER_FOUND_MSG, reply_markup=chat_keyboard)
